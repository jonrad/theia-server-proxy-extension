...
RUN echo "cd /home/gitpod/theia/ && node /home/gitpod/theia/browser-app/src-gen/backend/main.js /workspace/theia-server-proxy-extension/demo --port 23000 --hostname 0.0.0.0" >> /home/gitpod/.bashrc
